...
import { PlusCircle, Search, Clock, CheckCircle, Wallet, FileText, UserCircle } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10">
        ...
        <div className="mt-4 md:mt-0 flex gap-4">
          ...
          <Link to="/post-job" className="flex items-center px-6 py-3 bg-brand-600 text-white rounded-xl font-medium hover:bg-brand-700 transition-colors">
